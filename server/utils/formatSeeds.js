//add uuid to objects and re-format to JSONL for S3 Select
...
const processJsonFile = (inputFilePath, intermediateFilePath, outputFilePath) => {
    // Read the JSON file
    ...
    fs.writeFileSync(intermediateFilePath, JSON.stringify(updatedData, null, 2), 'utf8');

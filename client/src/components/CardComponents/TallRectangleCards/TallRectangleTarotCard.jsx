...
function TarotCard() {
    ...
    const handleCardClick = () => {
        setViewState((prev) => {
            if (prev === 2) {
                // We're currently at the info stage
    ...
    return (
        <div
            ...
            <div className='card'>
                ...
                <div
                    className='side back'
                    style={{ transform: viewState === 0 || viewState === 2 ? 'rotateY(0deg)' : 'rotateY(180deg)' }}>
                    {viewState === 1 && <CardBack />}
                </div>
                <div
                    className='side info'
                    style={{ transform: viewState === 0 || viewState === 1 ? 'rotateY(-180deg)' : 'rotateY(0deg)' }}>

...
const HeroSectionThree = ({ handleDotClick }) => {
  const mobileStepperItems = useMemo(
    () => [
      {
        image: Cards,
        alt: 'Tarot Card Icon',
        text: 'Tarot<br />Readings',
        description: <CardDescription />,
      },
      {
        image: Dashboard,
        alt: 'Computer Dashboard Icon',
        text: 'Custom<br />Dashboard',
        description: <DashboardDescription />,
      },
      {
        image: Journal,
        alt: 'Journal Icon',
        text: 'Tarot<br />Journal',
        description: <JournalDescription />,
      },
      {
        image: Hands,
        alt: 'Hands Share Icon',
        text: 'Share<br />Readings',
        description: <HandsDescription />,
      },
    ],
    []
  );
      ...
      <div className='text-center icons-row mb-2'>
        {mobileStepperItems.map((item, index) => (
          <div key={index} onClick={() => handleItemClick(index)}>
            <img src={item.image} alt={item.alt} className='icon' />

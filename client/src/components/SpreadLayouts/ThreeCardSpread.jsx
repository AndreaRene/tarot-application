    ...
    return (
        <section id='threeCardSpread'>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'self-end' }}>
                ...
                <img src={CardFront} style={{ height: imgHeight, margin: margin }} className='position_two' />
                <img src={CardFront} style={{ height: imgHeight, margin: margin }} className='position_three' />
            </div>

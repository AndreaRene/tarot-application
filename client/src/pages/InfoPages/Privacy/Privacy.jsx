const Privacy = () => {
    return (
        <section style={{ width: '60%', margin: 'auto', marginTop: '2rem' }}>
            ...
            <p>TarotDeck ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our App/Website ("Service"). We do not sell, trade, or otherwise transfer your personal information to third parties, including affiliates. We may share your information with trusted third parties who assist us in operating our Service, conducting our business, or serving our users, provided those parties agree to keep this information confidential.</p>

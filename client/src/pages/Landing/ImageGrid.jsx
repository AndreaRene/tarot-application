        ...
        <div>
            <div id='grid'>
                <div className='left-img'
                    onMouseEnter={() => handleMouseEnter('Daily Focus Spread', 'Draw a single card each day to gain insight for the day ahead, offering a focused practice of self-reflection.')}

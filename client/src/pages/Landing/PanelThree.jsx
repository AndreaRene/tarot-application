        ...
        <div className='panel-container'>
            <div className='crystal-hero'
                ...
                <div className='icon-container'>
                    <div className={`icon ${selectedIcon === 'Readings' ? 'selected' : ''}`} onClick={() => handleLinkClick(<CardsDesc />, 'Readings')}>
                    ...
                    <div className={`icon ${selectedIcon === 'Dashboard' ? 'selected' : ''}`} onClick={() => handleLinkClick(<DashboardDesc />, 'Dashboard')}>
                    ...
                    <div className={`icon ${selectedIcon === 'Community' ? 'selected' : ''}`} onClick={() => handleLinkClick(<HandsDesc />, 'Community')}>
                    ...
                    <div className={`icon ${selectedIcon === 'App Store' ? 'selected' : ''}`} onClick={() => handleLinkClick(<StoreDesc />, 'App Store')}>
                        <img src={CardIcon} alt="Card Reading Icon" />
                        <a href="#share" style={{ textDecoration: 'none', color: 'inherit' }}>
